...
typedef struct {
	...
	GPIO_Reg_t* GPIO_Port;		//select GPIO port to be used as EXTI port
...
typedef struct {
	...
	NVIC_Cfg_t	EXTI_Priority;		//select IRQ Priority group and subgroup

	EXTI_Sense_t Trigger_State;		//select trigger state (edge trigger)
	//this parameter can be a value of

	STD_Bool IRQ_EN;			//select pending request register state
