 ...
 *  GLOBAL FUNCTIONS
 *********************************************************************************************************************/
void MCA_STK_vInit(STK_Cfg_t* Copy_STK_Cfg)
{
...
void MCA_STK_vSetBusyWait(u32 Copy_u32Ticks)
{
...
void MCA_STK_vSetIntervalSingle(u32 Copy_u32Ticks, void (*Copy_Ptr)(void))
{
...
void MCA_STK_vSetIntervalPeriodic(u32 Copy_u32Ticks, void (*Copy_Ptr)(void))
{
	STK->STK_LOAD = Copy_u32Ticks - 1UL;
...
void MCA_STK_vStopInterval(void)
{
...
u32 MCA_STK_u32GetElapsed(void)
{
	u32 Copy_u32Ticks;
...
u32 MCA_STK_u32GetRemaining(void)
{
 u32 Copy_u32Ticks;
